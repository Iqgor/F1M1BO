...
def start():
    ...
    time.sleep(1)
    print("Je kan in dit verhaal is 1 mystryitem te vinden hierdoor heb je toegang tot een veiliger pad.\nOok heb je 5 health en door de keuzes die je maakt gaat er health af of health bij!\n")
    print("Oke start!\n")
    time.sleep(1.5)
    vraag1()
def vraag1(): 
...
def vraag3():
    ...
    if vraag3_0 == 'STELEN':
        ...
        vraag3()
def vraag4():
    print("Je hebt gegeten, ga je meteen DOOR of nog RUSTEN? ")
    v4 = input("==>")
    vraag4_0=v4.upper()
    if vraag4_0 == 'DOOR':
        print("Je gaat meeten verder lopend.\nHierdoor ben je wel sneller alleen verlies je wel wat health.")
        listofGlobals = globals()
        listofGlobals['health'] -=1
        print("Je hebt",health,"health")
        vraag6()
        ...
        vraag4()  
def vraag5():
    print("Je komt aan bij een haven ergens in Turkije, je moet gaan kiezen of LOPEND of per BOOT wil.")
    v5 = input("==>")
    vraag5_0=v5.upper()
    if vraag5_0 == 'BOOT':
...
def vraag8():
    ...
    if vraag8_0 == "legaal":
        ...
        print("Je wil gaan zwart werken want daar verdien je meer")
        vraag10()
    else:
        print("Dit is geen geldig antwoord!")
        vraag8()
...
def vraag12():
    ...
    if vraag12_0 == 'SHELTER':
        print("Je hebt shelter gezocht en hierdoor kan veilig door lopen naar je bestemming!")
        nederland()
...
def vraag16():
    ...
    vraag16_0=v16.upper()
    if vraag16_0 == 'JA':
        print("je gaat meedoen aan voor leiderschap!")
        vraag17()
    elif vraag16_0 == 'NEE':
...
def vraag19():
    ...
    if vraag19_0 == 'DOOR':
        ...
        print("Je wou terug gaan alleen dit liep fataal af daar ben je nu:")
        dood()
    else:
        print("Dit is geen geldig antwoord!")
        vraag19()
